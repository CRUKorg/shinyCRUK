...
crukFooter <- function() {
  ...
  citation_path <- system.file("markdown", "citation-text.html", package = "crukShiny")
  email_site_path <- system.file("markdown", "email-site-text.html", package = "crukShiny")
  ...
  htmltools::div(
    ...
    htmltools::div(
      ...
      htmltools::div(
        htmltools::a(
          htmltools::img(
            src = "crukShiny/images/cruk-logo.svg",
    ...
    htmltools::a(
      htmltools::img(
        src = "crukShiny/images/logo-fundraising-regulator-reg.svg",
        height = "97px",
